...
print stdout.readlines(), stderr.readlines()
#download index file
response = urllib2.urlopen('http://webdatacommons.org/hyperlinkgraph/data/index.list.txt')
...
for line in response:
    ...
    #copy to S3
    stdin, stdout, stderr = ssh.exec_command('aws s3 cp wdc s3://wdc-weighted-graph/index --recursive')
    print stdout.readlines(), stderr.readlines()
